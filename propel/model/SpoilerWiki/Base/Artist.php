...
abstract class Artist implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\SpoilerWiki\\Map\\ArtistTableMap';
    ...
    /**
     * Initializes internal state of SpoilerWiki\Base\Artist object.
     */
     ...
     * @return $this|\SpoilerWiki\Artist The current object (for fluent API support)
     */
    ...
    public function setBio($v)
    {
        ...
        if ($this->bio !== $v) {
            $this->bio = $v;
            $this->modifiedColumns[ArtistTableMap::COL_BIO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ArtistTableMap::translateFieldName('Bio', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\SpoilerWiki\\Artist'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArtistTableMap::COL_BIO)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\SpoilerWiki\Artist
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SpoilerWiki\Artist The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArtistTableMap::COL_BIO)) {
            $criteria->add(ArtistTableMap::COL_BIO, $this->bio);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SpoilerWiki\Artist (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SpoilerWiki\Artist Clone of current object.
     * @throws PropelException
     */
    ...
    public function setCanons(Collection $canons, ConnectionInterface $con = null)
    {
        ...
        foreach ($canonsToDelete as $canonRemoved) {
            $canonRemoved->setprimaryArtist(null);
        }
    ...
    public function setWorks(Collection $works, ConnectionInterface $con = null)
    {
        ...
        foreach ($worksToDelete as $workRemoved) {
            $workRemoved->setprimaryArtist(null);
        }
