...
/**
 * Base class that represents a row from the 'work_type' table.
 *
 * 
 *
* @package    propel.generator.SpoilerWiki.Base
*/
abstract class WorkType implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\SpoilerWiki\\Map\\WorkTypeTableMap';
    ...
    /**
     * The value for the work_label field.
     * 
     * @var        string
     */
    protected $work_label;

    /**
     * The value for the milestone_label field.
     * 
     * @var        string
     */
    ...
    /**
     * Compares this with another <code>WorkType</code> instance.  If
     * <code>obj</code> is an instance of <code>WorkType</code>, delegates to
     * <code>equals(WorkType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|WorkType The current object, for fluid interface
     */
    ...
    /**
     * Get the [work_label] column value.
     * 
     * @return string
     */
    ...
    /**
     * Get the [milestone_label] column value.
     * 
     * @return string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[WorkTypeTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[WorkTypeTableMap::COL_NAME] = true;
        }
    ...
    /**
     * Set the value of [work_label] column.
     * 
     * @param string $v new value
     * @return $this|\SpoilerWiki\WorkType The current object (for fluent API support)
     */
    public function setworkLabel($v)
    {
        ...
        if ($this->work_label !== $v) {
            $this->work_label = $v;
            $this->modifiedColumns[WorkTypeTableMap::COL_WORK_LABEL] = true;
        }
    ...
    public function setmilestoneLabel($v)
    {
        ...
        if ($this->milestone_label !== $v) {
            $this->milestone_label = $v;
            $this->modifiedColumns[WorkTypeTableMap::COL_MILESTONE_LABEL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WorkTypeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = WorkTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\SpoilerWiki\\WorkType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(WorkTypeTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildWorkTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see WorkType::setDeleted()
     * @see WorkType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getWriteConnection(WorkTypeTableMap::DATABASE_NAME);
        }

        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWorkTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WorkTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[WorkTypeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . WorkTypeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(WorkTypeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(WorkTypeTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(WorkTypeTableMap::COL_WORK_LABEL)) {
            $modifiedColumns[':p' . $index++]  = '`work_label`';
        }
        if ($this->isColumnModified(WorkTypeTableMap::COL_MILESTONE_LABEL)) {
            $modifiedColumns[':p' . $index++]  = '`milestone_label`';
        }

        $sql = sprintf(
            'INSERT INTO `work_type` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`name`':                        
                        ...
                        break;
                    case '`work_label`':                        
                        $stmt->bindValue($identifier, $this->work_label, PDO::PARAM_STR);
                        break;
                    case '`milestone_label`':                        
                        $stmt->bindValue($identifier, $this->milestone_label, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = WorkTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['WorkType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['WorkType'][$this->hashCode()] = true;
        $keys = WorkTypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\SpoilerWiki\WorkType
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SpoilerWiki\WorkType The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(WorkTypeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(WorkTypeTableMap::COL_ID)) {
            $criteria->add(WorkTypeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(WorkTypeTableMap::COL_NAME)) {
            $criteria->add(WorkTypeTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(WorkTypeTableMap::COL_WORK_LABEL)) {
            $criteria->add(WorkTypeTableMap::COL_WORK_LABEL, $this->work_label);
        }
        if ($this->isColumnModified(WorkTypeTableMap::COL_MILESTONE_LABEL)) {
            $criteria->add(WorkTypeTableMap::COL_MILESTONE_LABEL, $this->milestone_label);
        }
    ...
    {
        $criteria = ChildWorkTypeQuery::create();
        $criteria->add(WorkTypeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SpoilerWiki\WorkType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SpoilerWiki\WorkType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildWorkType is new, it will return
    ...
    public function clear()
    {
        $this->id = null;
        $this->name = null;
        $this->work_label = null;
        $this->milestone_label = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
        $this->setNew(true);
    ...
    {
        return (string) $this->exportTo(WorkTypeTableMap::DEFAULT_STRING_FORMAT);
    }
