...
abstract class Summary implements ActiveRecordInterface 
{
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[SummaryTableMap::COL_CONTENT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SummaryTableMap::translateFieldName('Content', TableMap::TYPE_PHPNAME, $indexType)];
            $this->content = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SummaryTableMap::translateFieldName('TopicId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->topic_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SummaryTableMap::translateFieldName('IntroducedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = SummaryTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SummaryTableMap::COL_CONTENT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SummaryTableMap::COL_CONTENT)) {
            $criteria->add(SummaryTableMap::COL_CONTENT, $this->content);
        }
        if ($this->isColumnModified(SummaryTableMap::COL_TOPIC_ID)) {
