...
use SpoilerWiki\Artist;
use SpoilerWiki\ArtistQuery;
...
class ArtistTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'SpoilerWiki.Map.ArtistTableMap';
     ...
     */
    const OM_CLASS = '\\SpoilerWiki\\Artist';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'SpoilerWiki.Artist';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Bio', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'bio', ),
        self::TYPE_COLNAME       => array(ArtistTableMap::COL_ID, ArtistTableMap::COL_NAME, ArtistTableMap::COL_BIO, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'bio', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Bio' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'bio' => 2, ),
        self::TYPE_COLNAME       => array(ArtistTableMap::COL_ID => 0, ArtistTableMap::COL_NAME => 1, ArtistTableMap::COL_BIO => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'bio' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\SpoilerWiki\\Artist');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ArtistTableMap::COL_BIO);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SpoilerWiki\Artist) { // it's a model object
