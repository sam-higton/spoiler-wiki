...
use SpoilerWiki\Topic;
use SpoilerWiki\TopicQuery;
...
class TopicTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'SpoilerWiki.Map.TopicTableMap';
     ...
     */
    const OM_CLASS = '\\SpoilerWiki\\Topic';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'SpoilerWiki.Topic';
     ...
     */
    const COL_NAME = 'topic.name';

    /**
     * the column name for the canon_id field
     */
    const COL_CANON_ID = 'topic.canon_id';

    /**
     * the column name for the introduced_at field
     */
    const COL_INTRODUCED_AT = 'topic.introduced_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'CanonId', 'IntroducedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'canonId', 'introducedAt', ),
        self::TYPE_COLNAME       => array(TopicTableMap::COL_ID, TopicTableMap::COL_NAME, TopicTableMap::COL_CANON_ID, TopicTableMap::COL_INTRODUCED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'canon_id', 'introduced_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'CanonId' => 2, 'IntroducedAt' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'canonId' => 2, 'introducedAt' => 3, ),
        self::TYPE_COLNAME       => array(TopicTableMap::COL_ID => 0, TopicTableMap::COL_NAME => 1, TopicTableMap::COL_CANON_ID => 2, TopicTableMap::COL_INTRODUCED_AT => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'canon_id' => 2, 'introduced_at' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\SpoilerWiki\\Topic');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('introducedAt', '\\SpoilerWiki\\Milestone', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':introduced_at',
    1 => ':id',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TopicTableMap::COL_CANON_ID);
            $criteria->addSelectColumn(TopicTableMap::COL_INTRODUCED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SpoilerWiki\Topic) { // it's a model object
