...
class SummaryTableMap extends TableMap
{
     ...
     */
    const COL_CONTENT = 'summary.content';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SummaryTableMap::COL_ID, SummaryTableMap::COL_CONTENT, SummaryTableMap::COL_TOPIC_ID, SummaryTableMap::COL_INTRODUCED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SummaryTableMap::COL_ID => 0, SummaryTableMap::COL_CONTENT => 1, SummaryTableMap::COL_TOPIC_ID => 2, SummaryTableMap::COL_INTRODUCED_AT => 3, ),
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SummaryTableMap::COL_CONTENT);
