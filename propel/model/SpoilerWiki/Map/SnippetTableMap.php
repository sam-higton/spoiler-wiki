...
use SpoilerWiki\Snippet;
use SpoilerWiki\SnippetQuery;
...
class SnippetTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'SpoilerWiki.Map.SnippetTableMap';
     ...
     */
    const OM_CLASS = '\\SpoilerWiki\\Snippet';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'SpoilerWiki.Snippet';
     ...
     */
    const COL_TOPIC_ID = 'snippet.topic_id';

    /**
     * the column name for the introduced_at field
     */
    const COL_INTRODUCED_AT = 'snippet.introduced_at';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\SpoilerWiki\\Snippet');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SpoilerWiki\Snippet) { // it's a model object
